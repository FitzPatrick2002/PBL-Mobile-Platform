 ...
 * 
 * // Init the spinlock (necessary for protection of resources in parallel systems).
...
public:
    ...
    ///        Default separator: ';'
    ///        Default decimal:   '.'
    ///        Columns: x | y | theta | totalDistance[0] | totalDistance[1] | totalDistance[2]
