"""
This module contains open3d window with the current scanned session.
It also provides methods of communication and callbacks.
"""
import os.path
import time
...
class VisualizationApp:
    ...
    Important arguments:
        ...
        _queue -- Queue from the Multiprocessing module.
    ...
    def __init__(self, queue : multiprocessing.Queue, o3d_to_f : multiprocessing.Queue):
        ...
        Keyword arguments:
            ...
            o3d_to_f -- Queue used to communicate with the Flask server.
        """
    ...
    def _barycentre_window(self):
        ...
        def barycenter_dialog_callback():
            ...
            """Retrieves barycenter data and adds it as geometry to the scene & 
                stores in the self._scene_pcds.
            """
        ...
        match message["type"]:
            ...
            case "session":
                """Clear the scene and change currently selected session folder.
                    Load the selected session data into the scene,
                """
    ...
    def _add_pcd(self, pcd : o3d.geometry.PointCloud, name : str, color : List[float] = None):
        ...
        Keyword arguments:
            ...
            name -- Specifies to which pcd in the #_scene_pcds will the new pcd be appended.
    ...
    def _lidar_to_pcd(self, lidar_data : LidarScan) -> o3d.geometry.PointCloud:
        ...
        Keyword arguments:
            lidar_data -- Lidar data to be processed.

        Returns:
            Lidar data -- PointCloud in cartesian coordinate frame.
        """
        ...
        """Convert into a list of points [[x0, y0, z0], ...]"""
    ...
    def _odometry_to_pcd(self, odometry_data : OdometryData) -> o3d.geometry.PointCloud:
        ...
        Keyword arguments:
            odometry_data -- OdometryData object. Data should be only in 2D format.
                            (List of [x0, y0, x1, y0, ...])

        Returns:
            Odometry readings converted to o3d format, represented as PointCloud object.
        """
